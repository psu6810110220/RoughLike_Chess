...
class DemonTribe:
    def __init__(self):
        ...
        self.piece_passives = {
            "pawn":   {"starting_points": 0, "coin_tosses": 2, "max_points": 6, "description": "Demon Minion: Unpredictable attack power."},
            ...
            "queen":  {"starting_points": 0, "coin_tosses": 4, "max_points": 16, "description": "Demon Queen: Peak power upon successful tosses."},
