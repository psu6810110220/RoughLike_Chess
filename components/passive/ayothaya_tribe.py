...
class AyothayaTribe:
    def __init__(self):
        ...
        self.piece_passives = {
            "pawn":   {"starting_points": 2, "coin_tosses": 3, "max_points": 14, "description": "Brave Soldier: Strong base power and determination."},
            "knight": {"starting_points": 6, "coin_tosses": 4, "max_points": 20, "description": "Atamat Corps: Agile with high impact power."},
            "bishop": {"starting_points": 8, "coin_tosses": 3, "max_points": 15, "description": "Royal Astrologer: Consistent mystical power."},
            "rook":   {"starting_points": 8, "coin_tosses": 3, "max_points": 8, "description": "Siam Fortress: Reliable defensive certainty."},
            "queen":  {"starting_points": 2, "coin_tosses": 8, "max_points": 43, "description": "Female General: Deadly slashes with 7 tosses."},
